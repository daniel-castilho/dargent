...
7. `tasks/m0-foundations/foundations-m0-spec.md`
8. `tasks/m0-foundations/foundations-m0-backlog.md`
9. `tasks/m0-foundations/foundations-m0-implementation-sequence.md` — **your execution script**
10. `tasks/m0-foundations/m0-acceptance-matrix.md` — the closure artifact you fill
