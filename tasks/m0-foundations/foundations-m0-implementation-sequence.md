...
### Actions
1. Fill every `pending` cell of `tasks/m0-foundations/m0-acceptance-matrix.md`: CI run links, command outputs, file paths.
...
### Verify
```bash
grep -c pending tasks/m0-foundations/m0-acceptance-matrix.md   # expect 0
