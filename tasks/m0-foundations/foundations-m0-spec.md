...
## 6. Verification matrix (maps to `tasks/m0-foundations/m0-acceptance-matrix.md`)
...
- [ ] §6 verification matrix fully evidenced in `tasks/m0-foundations/m0-acceptance-matrix.md` (zero `pending`)
