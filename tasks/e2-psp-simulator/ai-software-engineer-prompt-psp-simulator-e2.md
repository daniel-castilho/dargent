...
7. `tasks/e2-psp-simulator/psp-simulator-e2-spec.md` — the exact contracts (the webhook contract table is binding for E4 too)
8. `tasks/e2-psp-simulator/psp-simulator-e2-backlog.md`
9. `tasks/e2-psp-simulator/psp-simulator-e2-implementation-sequence.md` — **your execution script**
...
- [ ] `tasks/e2-psp-simulator/e2-acceptance-matrix.md` fully evidenced; epics ledger updated (E2 ✅); CHANGELOG entry;
