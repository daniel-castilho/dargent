...
### Actions
1. Fill `tasks/e2-psp-simulator/e2-acceptance-matrix.md` (run links, test names, knob-to-test mapping).
...
### Verify
```bash
grep -n pending tasks/e2-psp-simulator/e2-acceptance-matrix.md   # expect: no output (zero pending)
