...
3. `tasks/e8-refunds/refunds-e8-spec.md` — exact contracts (DDL V112, API, event payload, ledger branch,
...
- **Block 1** — DEBT-5 barrier (step 0), V112 refunds table, refund use case (TDD), REST endpoint +
  ...
  Prompt: `tasks/e8-refunds/refunds-e8-execution-prompt-block1.md`.
