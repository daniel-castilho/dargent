...
1. `tasks/e8-refunds/refunds-e8-spec.md` §1–§5, §7 (§6/§8 are Block 2) — the contracts.
2. `tasks/e8-refunds/refunds-e8-sequence.md` — order + playbooks P1–P6 (P4 = D8 rounding).
3. `tasks/e8-refunds/refunds-e8-backlog.md` — S0–S5 acceptance.
