...
- [x] `tasks/e3r-create-webhook-remediation/e3r-acceptance-matrix.md` created with CI run IDs
- [x] `tasks/e3-create-payment/e3-acceptance-matrix.md` rewritten (this file)
- [x] `tasks/e4-webhook-intake/e4-acceptance-matrix.md` rebuilt from scratch (E3R R7)
- [x] `tasks/e3r-create-webhook-remediation/e3r-acceptance-matrix.md` created
