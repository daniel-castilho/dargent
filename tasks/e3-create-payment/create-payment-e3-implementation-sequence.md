...
### Actions
1. Fill `tasks/e3-create-payment/e3-acceptance-matrix.md` (requirement → implementation → test → evidence).
...
### Verify
```bash
grep -n pending tasks/e3-create-payment/e3-acceptance-matrix.md    # expect: no output
