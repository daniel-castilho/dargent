...
6. `tasks/e3-create-payment/create-payment-e3-spec.md` — the exact contracts (§5.1.3 idempotency table and §5.8 transactional
   script are binding; §5.5 golden BR Code vector is asserted byte-exact)
7. `tasks/e3-create-payment/create-payment-e3-backlog.md`
8. `tasks/e3-create-payment/create-payment-e3-implementation-sequence.md` — **your execution script**
...
- [ ] `tasks/e3-create-payment/e3-acceptance-matrix.md` zero pending; ledger E3 ✅; CHANGELOG; design §6.3/§5.1 synced;
