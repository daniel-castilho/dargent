...
**Valid for:** exactly the stories R5, R6 of `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-backlog.md` **plus the audit
...
1. `tasks/e4-webhook-intake/webhook-intake-e4-spec.md` — **§5.1 (pipeline order is binding), §5.2 (validator + vectors), §5.3
...
2. `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-spec.md` — §2 register (MS-3 is yours to close) and §5.5 (vectors).
3. `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-backlog.md` (R5, R6) + implementation sequence (Steps 5–6).
