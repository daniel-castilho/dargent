...
1. `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-spec.md` — §2 register (BD-1…BD-14, MS-1…MS-3, TD-1…TD-11) is the
   closure checklist; §5.6 the ledger row texts; §5.7 the governance texts (this block amends/extends them).
2. `tasks/e3r-create-webhook-remediation/e3r-block1-verification.md` — the audit trail: commit chains, run tables, adjudications (DEV-R2-4,
   DEV-R6), A0 tables. Copy evidence FROM it, never from memory.
3. `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-backlog.md` / `-implementation-sequence.md` (R7/R8 steps).
4. `AGENTS.md` (you will amend), `docs/lessons.md` (you will write #14), `docs/epics.md` (you will flip), and
   `tasks/e4-webhook-intake/webhook-intake-e4-spec.md` (you will amend §5.3 step 7 per BD-14).
...
- [ ] **`tasks/e3r-create-webhook-remediation/e3r-acceptance-matrix.md` rebuilt cell-by-cell from spec §2** (the committed placeholder is TD-9:
...
- [ ] **`tasks/e3-create-payment/e3-acceptance-matrix.md` rewritten** (prior non-CI evidence voided; superseded-by-E3R noted; TD-1
...
- [ ] **`tasks/e4-webhook-intake/e4-acceptance-matrix.md` rebuilt from scratch** (the `97882494` fabrication was banner-voided):
