...
- [ ] **Truth-correction commit (docs-only, first):** replace `docs/epics.md` with the corrected ledger
      ...
      `tasks/e4-webhook-intake/e4-acceptance-matrix.md` (fabricated evidence, cites non-existent tests)
...
### Work
- [ ] `tasks/e3r-create-webhook-remediation/e3r-acceptance-matrix.md` created (register ID → implementation → CI test → run id)
- [ ] `tasks/e3-create-payment/e3-acceptance-matrix.md` rewritten: prior non-CI evidence voided and replaced (or explicitly marked
      superseded-by-E3R); `tasks/e4-webhook-intake/e4-acceptance-matrix.md` **rebuilt from scratch** — the `97882494` version is
