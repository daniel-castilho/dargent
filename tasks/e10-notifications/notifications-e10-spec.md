...
| S0 matrix nit | citation pair completed | diff | canonical table `tasks/e3r-create-webhook-remediation/e3r-block1-verification.md` | ✅ |
...
| S6 | API contract | `NotificationsApiIT` | #118 `33683261976` (+ TD-20 rider; see S6-rider row below) | ✅ |
| S7 | docs + flip + M2 ✅ | commit pair (README/CHANGELOG/this row) | #119 `33684112090` | ✅ |
| S6-rider | TD-20: merchantId echo + cross-tenant proof + naming negatives | `NotificationsApiIT.cross_tenant_rows_are_never_visible_across_credentials` + shape negatives | #123 `33690323704` | ✅ |
