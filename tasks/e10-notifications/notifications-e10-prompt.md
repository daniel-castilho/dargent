...
3. `tasks/e10-notifications/notifications-e10-spec.md` — exact contracts (env §4.1, DDL, API, IT names). Deviations
...
- **Block 1** — step 0 riders (TD-15 + BD-15R + matrix nit), then module scaffold, consumer, ITs.
  Prompt: `tasks/e10-notifications/notifications-e10-execution-prompt-block1.md`.
