...
1. `tasks/e10-notifications/notifications-e10-spec.md` — §1–§6 and §8–§9 govern this block (§7 is Block 2).
2. `tasks/e10-notifications/notifications-e10-sequence.md` — order + failure playbooks (P1–P6).
3. `tasks/e10-notifications/notifications-e10-backlog.md` — S0–S5 acceptance.
...
### 0c. `docs(e7): complete race-row citation pair in matrix` — tasks/e7-ledger-core/e7-acceptance-matrix.md only
...
Order and acceptance per `tasks/e10-notifications/notifications-e10-backlog.md` (S1–S5); contracts per spec.
