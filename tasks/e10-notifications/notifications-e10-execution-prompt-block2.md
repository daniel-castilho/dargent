...
`tasks/e10-notifications/notifications-e10-spec.md` §5 (read side) + §7 (read API) as amended below · §8.3 `NotificationsApiIT`
...
2. `tasks/e10-notifications/notifications-e10-spec.md` §10 matrix: fill S6/S7 rows with real pairs; status ✅ where proven.
