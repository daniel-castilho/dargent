...
1. `tasks/e35-repo-hardening/repo-hardening-e35-spec.md` — **the contract**: §5 blocks verbatim, §5.1 protection rationale,
   §5.9 limits table, §5.10 Makefile targets
2. `tasks/e35-repo-hardening/repo-hardening-e35-backlog.md`
3. `tasks/e35-repo-hardening/repo-hardening-e35-implementation-sequence.md` — **your execution script**
...
- [ ] `tasks/e35-repo-hardening/e35-acceptance-matrix.md` zero pending; ledger E3.5 ✅; CHANGELOG; lessons entry if the
