...
### Actions
1. Fill `tasks/e35-repo-hardening/e35-acceptance-matrix.md` (§5 contract → change → proof → evidence).
...
### Verify
```bash
grep -n pending tasks/e35-repo-hardening/e35-acceptance-matrix.md    # expect: no output
