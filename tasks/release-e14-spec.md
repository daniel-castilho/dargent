...
| S5 | two-release migration verdict | `docs/releases/v1.0.0-migration-review.md` — 10/11 expand-only (TD-33 ALLOW-with-log), F1: V301 content changed post-v0.3.0 (empirically reproduced: checksum mismatch on boot); gate `--check HEAD` PASS 11/11 | ✅ (F1 owner decision pending) |
