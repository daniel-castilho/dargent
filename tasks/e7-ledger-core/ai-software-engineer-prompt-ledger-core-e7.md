...
1. `tasks/e7-ledger-core/ledger-core-e7-spec.md` — §4.1 env contract, §5 exact contracts (posting rules §5.3 are the money
   math), §6 races, §7 tests, §9 DoD.
2. `tasks/e7-ledger-core/ledger-core-e7-implementation-sequence.md` — S0…S7, global rules, failure playbooks.
3. `tasks/e7-ledger-core/ledger-core-e7-backlog.md` — acceptance anchors.
4. `tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-spec.md` §2 + `tasks/e3r-create-webhook-remediation/e3r-block1-verification.md` + E6 matrix —
