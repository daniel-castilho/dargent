...
1. `tasks/e7-ledger-core/ledger-core-e7-spec.md` — §2 current state, §4.1 env, §5 contracts (§5.3 posting rules = the
   money math), §5.7 guarantee statement.
2. `tasks/e7-ledger-core/ledger-core-e7-implementation-sequence.md` — rules + playbooks.
3. `tasks/e7-ledger-core/ledger-core-e7-backlog.md` — anchors.
4. Canonical pair tables: `tasks/e3r-create-webhook-remediation/e3r-block1-verification.md` + E6 matrix §Run IDs.
