...
## 10. Verification matrix (maps to `tasks/e1-payment-domain/e1-acceptance-matrix.md`)
...
- [ ] §10 matrix fully evidenced (zero pending) in `tasks/e1-payment-domain/e1-acceptance-matrix.md`
