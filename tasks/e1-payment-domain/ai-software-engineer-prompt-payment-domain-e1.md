...
8. `tasks/e1-payment-domain/payment-domain-e1-spec.md` — the exact contracts
9. `tasks/e1-payment-domain/payment-domain-e1-backlog.md` — stories and acceptance
10. `tasks/e1-payment-domain/payment-domain-e1-implementation-sequence.md` — **your execution script**
...
- [ ] design.md §5.1 synced (`description` column); epics.md E1 flipped; `tasks/e1-payment-domain/e1-acceptance-matrix.md`
