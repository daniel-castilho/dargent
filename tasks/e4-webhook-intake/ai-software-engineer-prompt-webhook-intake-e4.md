...
1. **`tasks/e4-webhook-intake/webhook-intake-e4-spec.md`** — §5.1 pipeline order, §5.2 validator + vectors, §5.3 tx script,
   §5.4 DDL (the contracts; byte-binding)
2. `tasks/e4-webhook-intake/webhook-intake-e4-backlog.md`
3. `tasks/e4-webhook-intake/webhook-intake-e4-implementation-sequence.md` — **your execution script** (Step 0 is a GATE)
...
- [ ] `tasks/e4-webhook-intake/e4-acceptance-matrix.md` zero pending; ledger E4 ✅ with the REAL green run id; CHANGELOG;
