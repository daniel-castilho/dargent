...
### Actions
1. Fill `tasks/e4-webhook-intake/e4-acceptance-matrix.md`; ledger E4 → ✅ with the REAL green run id; CHANGELOG; lessons.
...
### Verify
```bash
grep -n pending tasks/e4-webhook-intake/e4-acceptance-matrix.md    # expect: no output
