...
2. `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-design-seed.md` — **pre-adjudicated decisions** (2026-08-29):
...
3. `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-spec.md` — exact contracts (§4.1 env, DDL, flows, IT names).
...
- **Block 1** — step 0 rider (DEBT-1), V111, expiration scheduler, reconciler engine, core ITs
  (scenarios 26 + 11). Prompt: `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-execution-prompt-block1.md`.
