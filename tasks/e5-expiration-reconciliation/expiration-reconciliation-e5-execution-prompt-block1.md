...
1. `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-spec.md` §1–§5, §8 (§6/§7 are Block 2).
2. `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-design-seed.md` — pre-adjudicated (polling, ladder, V111,
   no-@Transactional-on-scheduled, no ShedLock, audit command names, late=true in envelope).
3. `tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-sequence.md` — order + playbooks P1–P6.
