...
1. Repo spec (`tasks/e5-expiration-reconciliation/expiration-reconciliation-e5-spec.md`): §2 V111 numbering note (V109 was free;
...
2. Register copy in repo (`tasks/e3r-create-webhook-remediation/create-webhook-remediation-e3r-spec.md`): TD-21 + V-NUM-E5 rows land
