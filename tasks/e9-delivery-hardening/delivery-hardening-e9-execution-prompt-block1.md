...
1. `tasks/e9-delivery-hardening/delivery-hardening-e9-spec.md` §1–§5, §7 (S5/S6 are Block 2).
2. `tasks/e9-delivery-hardening/delivery-hardening-e9-sequence.md` — order + P1–P6 (P2: the ladder is frozen; P4:
   republish mints, never mutates).
3. `tasks/e9-delivery-hardening/delivery-hardening-e9-backlog.md` — S1–S4 acceptance.
