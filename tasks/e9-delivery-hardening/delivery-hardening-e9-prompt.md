...
3. `tasks/e9-delivery-hardening/delivery-hardening-e9-spec.md` — exact contracts (§4.1 env, requeue semantics, republish
...
- **Block 1** — exhaustion contract + requeue endpoint (scenarios 19's spine), republish tool +
  ...
  `tasks/e9-delivery-hardening/delivery-hardening-e9-execution-prompt-block1.md`.
