...
| DEBT-7 | `postJournal`/`postJournalWithoutBalances` duplication in the ledger store adapters (owner adjudication 2026-09-06: register & defer — do NOT consolidate inside E13; the duplication is deliberate to keep the E8/E9 guarantees untouched while gates land). | — | post-v1.0.0 candidate |
