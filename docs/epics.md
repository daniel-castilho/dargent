...
| E14 | Release engineering & restore drill | repo, docs | E12, E13 | post-M4 (cuts v1.0.0) | ◐ 2026-09-07 — Block 1 S0–S4: S0 governance sync (E9=23/23 TD-34, E14 package landed, PR #5 `c2e58c3`); S1 GHCR sha+edge push on main live (PR #6 `6c2e7a4`, images `sha-6c2e7a4`/`sha-f6d0303`+`edge`); S2 release.yml + rehearsals (PR #7 `f6d0303`, PR #8 `9d0ce22` — rc1 notes-plumbing fail → fix-forward rc2 GREEN run `34148023947`, digest+jar+SBOM parity verified); S3 backup/restore + republish machinery + systemd units (this PR — negative paths proven); S4 restore-drill CI job + record `docs/drills/restore-2026-09-07.md` (RTO 23s). S5–S8 pending channel audit |
