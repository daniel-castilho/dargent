...
| E15 | Operational hardening: alerts, load baseline, scale restore, PITR, webhook abuse controls, DEBT dispositions | api, deploy, docs | E11, E13, E14 | post-1.0.0 | ◐ |
| E16 | Stretch batch: card Strategy · k6 gate · Redis cache · webhook reprocessing | payments, api | E8 (card: E1, E2) | M5 | ☐ |
...
### E15 — Operational hardening (post-1.0.0)
