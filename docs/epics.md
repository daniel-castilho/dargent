...
| E5 | Expiration, resurrection & reconciliation | payments | E3R (E3+E4 remediated) | M3 | ✅ 2026-09-02 — runs #128 `33694469538` (V111 columns + index), #129 `33700561182` (expiration), #130 `33706674658` (reconciler confirms sc.26), #131 `33707174938` (resurrection sc.11/27), #132 `33709904795` (give-up S5), #133 `33710432248` (scenarios 9/10 S6), #134 `33711320405` (DEBT-4 journal coverage auditor) → #135 (docs + citation; unregistered per #57/#67 precedent) — matrix evidenced (`tasks/expiration-reconciliation-e5-spec.md` §10) — **DEBT-1 closed, DEBT-4 closed; M3 remains open for E8+E9** |
